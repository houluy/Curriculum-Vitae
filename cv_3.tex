...
\newfontfamily{\fzybxs}{fzybxs.ttf}
...
\begin{paracol}{2} % Begin the multi-column environment
	...
	\parbox[top][0.12\textheight][c]{\linewidth}{ % Parbox to hold the author name and CV text; fixed height to match the coloured box to the right, centred vertically and full line width
		...
		{\Huge \fzblack 侯 璐}\\\medskip % Your name
	...
	\parbox[top][0.12\textheight][c]{\linewidth}{ % Parbox to hold the colour box; fixed height to match the name/CV text to the left, centred vertically and full line width
		...
		\colorbox{shade}{ % Create the coloured box
			\begin{supertabular}{p{0.05\linewidth}|p{0.775\linewidth}} % Start a table with two columns, the table will ensure everything is aligned
				...
				\raisebox{-1pt}{\faLinkedinSquare} & \href{https://www.linkedin.com/in/houlu}{https://www.linkedin.com/in/houlu} \\ % LinkedIn profile
	...
	\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
		...
		\tableentry{精通}{Python, Node.js}{spaceafter}
		
		%------------------------------------------------
		
		\tableentry{熟悉}{C, \CPP, MATLAB, \LaTeX}{spaceafter}
		
		%------------------------------------------------
		
		\tableentry{了解}{Go, Rust}{spaceafter}
	...
	\longformpublication{Kan Zheng, \textbf{Lu Hou}, Hanling Meng, Qiang Zheng, Ning Lu, Lei Lei, ``Soft-defined heterogeneous vehicular network: architecture and challenges,'' \textit{IEEE Network}, vol. 30, no. 4, July 2016, pp. 72-80.\IF{7.23}}
	
	\longformpublication{\textbf{Lu Hou}, Shaohang Zhao, Xiong Xiong, Kan Zheng, Periklis Chatzimisios, M. Shamim Hossain, Wei Xiang, ``Internet of things cloud: architecture and implementation,'' \textit{IEEE Communications Magazine}, vol. 54, no. 12, Dec. 2016, pp. 32-39. \IF{10.435}}
	
	\longformpublication{\textbf{Lu Hou}, Shaohang Zhao, Xing Li, Periklis Chatzimisios, Kan Zheng, ``Design and implementation of application programming interface for Internet of things cloud,'' \textit{International Journal of Network Management}, vol. 27, no. 3, June 2016. \IF{1.118}}
	
	\longformpublication{\textbf{Lu Hou}, Kan Zheng, Periklis Chatzimisios, Yi Feng, ``A continuous-time Markov decision process-based resource allocation scheme in vehicular cloud for mobile video services,'' \textit{Computer Communications}, vol. 118, Mar. 2018, pp. 140-147. \IF{3.338}}
		
	\longformpublication{\textbf{Lu Hou}, Lei Lei, Kan Zheng, ``Design on publish/subscribe message dissemination for vehicular networks with mobile edge computing,'' \textit{2017 IEEE GLOBECOM}, Dec. 2017}
	
	\longformpublication{Xiong Xiong, \textbf{Lu Hou}, Kan Zheng, Wei Xiang, M. Shamim Hossain, and Sk Md Mizanur Rahman, ``SMDP-based radio resource allocation scheme in software-defined internet of things networks,'' \textit{IEEE Sensors Journal} vol. 16, no. 20, June 2016, pp. 7304-7314. \IF{2.512}}
				
	\longformpublication{Xiong Xiong, \textbf{Lu Hou}, Long Zhao, ``A Group-Based Massive Multiple Access Scheme in Cellular M2M Networks,'' \textit{Computer Communications}, vol. 121, May. 2018, pp. 44-49. \IF{3.338}}
...
\parbox[top][0.12\textheight][c]{\linewidth}{ % Parbox to hold the author name and CV text; fixed height to match the coloured box to the right, centred vertically and full line width
	\vspace{-0.04\textheight} % Reduce whitespace above the parbox to separate it from the main content
	\centering % Centre text
	{\sffamily\Huge Lu Hou}\\\medskip % Your name
	{\Huge\color{headings}\cvtextfont Curriculum Vitae}
}
...
\parbox[top][0.12\textheight][c]{\linewidth}{ % Parbox to hold the colour box; fixed height to match the name/CV text to the left, centred vertically and full line width
	...
	\colorbox{shade}{ % Create the coloured box
		\begin{supertabular}{p{0.05\linewidth}|p{0.775\linewidth}} % Start a table with two columns, the table will ensure everything is aligned
			\raisebox{-1pt}{\faHome} & No. 10, Xitucheng Road, Haidian District, Beijing \\ % Address
			\raisebox{-1pt}{\faPhone} & +86-15501081468 \\ % Phone number
			\raisebox{0pt}{\small\faEnvelope} & \href{mailto:houlu8674@bupt.edu.cn}{houlu8674@bupt.edu.cn} \\ % Email address
			\raisebox{-1pt}{\small\faDesktop} & \href{https://www.lucima.cn}{https://www.lucima.cn} \\ % Website
