...
\newfontfamily{\cvchsfont}[Path=fonts/]{fzybxs}
...
\usepackage[usenames,svgnames,dvipsnames]{xcolor} % Allows the definition and use of custom colours
...
\titleformat{\section}{\color{headings}\scshape\LARGE\raggedright}{}{0em}{}[\color{headings}\titlerule] % Define the \section format
...
\newcommand{\workposition}[5]{
	{\raggedleft\textsc{\textbf{#1}\expandafter\ifstrequal\expandafter{#2}{}{}{\hspace{6pt}\footnotesize{(#2)}}}\par} % Duration and conditional full time/part time text
	\expandafter\ifstrequal\expandafter{#3}{}{}{{\raggedright\large #3}\\} % Employer
	\expandafter\ifstrequal\expandafter{#4}{}{}{{\raggedright\large #4}\\[4pt]} % Job title
	\expandafter\ifstrequal\expandafter{#5}{}{}{#5\\} % Description
}

\newcommand{\chsworkposition}[5]{
	{\raggedright\textsc{\textbf{#1}\expandafter\ifstrequal\expandafter{#2}{}{}{\hspace{6pt}\footnotesize{(#2)}}}\par} % Duration and conditional full time/part time text
	\expandafter\ifstrequal\expandafter{#3}{}{}{{\raggedright\large #3}\\} % Employer
	\expandafter\ifstrequal\expandafter{#4}{}{}{{\raggedright #4}} % Job title
	\expandafter\ifstrequal\expandafter{#5}{}{}{#5} % Description
}
